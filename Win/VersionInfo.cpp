...
std::string CVersionInfo::GetFileVersionAsDotString()
{
	...
	E:/boost/::tokenizer<E:/boost/::char_separator<char> > tokens(v, E:/boost/::char_separator<char>(" ,."));
	std::string dotVersion;
	for (E:/boost/::tokenizer<E:/boost/::char_separator<char> >::iterator tok_iter = tokens.begin();
