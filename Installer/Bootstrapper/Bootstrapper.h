...
class Bootstrapper : public E:/boost/::enable_shared_from_this<Bootstrapper>, public IInstallerSite
{
	E:/boost/::condition_variable done;
	E:/boost/::mutex mut;
	...
	{
		{
			E:/boost/::unique_lock<E:/boost/::mutex> lock(mut);
			if (done.timed_wait(lock, E:/boost/::get_system_time() + E:/boost/::posix_time::time_duration(0, 0, windowDelay)))
				return;
		}
	...
	void showCancelAfterDelay()
	{
		{
			E:/boost/::unique_lock<E:/boost/::mutex> lock(mut);
			if (done.timed_wait(lock, E:/boost/::get_system_time() + E:/boost/::posix_time::time_duration(0, 0, cancelDelay)))
				return;
		}
...
protected:
	...
	E:/boost/::scoped_ptr<CMainDialog> dialog;
	E:/boost/::scoped_ptr<FileDeployer> deployer;
	CRegKey classesKey;
...
public:
	...
	static E:/boost/::shared_ptr<Bootstrapper> Create(HINSTANCE hInstance, Bootstrapper*(*newBootstrapper)(HINSTANCE));
	static bool hasSse2();
