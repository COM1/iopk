...
typedef struct _RobloxProxy_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } RobloxProxy_MIDL_TYPE_FORMAT_STRING;

typedef struct _RobloxProxy_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } RobloxProxy_MIDL_PROC_FORMAT_STRING;

typedef struct _RobloxProxy_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } RobloxProxy_MIDL_EXPR_FORMAT_STRING;
...
extern const RobloxProxy_MIDL_TYPE_FORMAT_STRING RobloxProxy__MIDL_TypeFormatString;
extern const RobloxProxy_MIDL_PROC_FORMAT_STRING RobloxProxy__MIDL_ProcFormatString;
extern const RobloxProxy_MIDL_EXPR_FORMAT_STRING RobloxProxy__MIDL_ExprFormatString;


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO ILauncher_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO ILauncher_ProxyInfo;
...
static const RobloxProxy_MIDL_PROC_FORMAT_STRING RobloxProxy__MIDL_ProcFormatString =
    {
        0,
        {
...
/* 172 */	0x8,		/* FC_LONG */
	...
	/* Procedure put_AuthenticationTicket */
...
/* 310 */	0x8,		/* FC_LONG */
	...
	/* Procedure SetSilentModeEnabled */
...
/* 466 */	0x8,		/* FC_LONG */
	...
	/* Procedure SetStartInHiddenMode */
...
/* 652 */	NdrFcShort( 0x2e ),	/* Type Offset=46 */
...
static const RobloxProxy_MIDL_TYPE_FORMAT_STRING RobloxProxy__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Object interface: ILauncher, ver. 0.0,
   GUID={0x699F0898,0xB7BC,0x4DE5,{0xAF,0xEE,0x0E,0xC3,0x8A,0xD4,0x22,0x40}} */

#pragma code_seg(".orpc")
static const unsigned short ILauncher_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO ILauncher_ProxyInfo =
    {
    &Object_StubDesc,
    RobloxProxy__MIDL_ProcFormatString.Format,
    &ILauncher_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO ILauncher_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    RobloxProxy__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(26) _ILauncherProxyVtbl = 
{
    &ILauncher_ProxyInfo,
    &IID_ILauncher,
    ...
    (void *) (INT_PTR) -1 /* ILauncher::StartGame */ ,
    (void *) (INT_PTR) -1 /* ILauncher::HelloWorld */ ,
    (void *) (INT_PTR) -1 /* ILauncher::Hello */ ,
    (void *) (INT_PTR) -1 /* ILauncher::get_InstallHost */ ,
    (void *) (INT_PTR) -1 /* ILauncher::Update */ ,
    (void *) (INT_PTR) -1 /* ILauncher::put_AuthenticationTicket */ ,
    (void *) (INT_PTR) -1 /* ILauncher::get_IsUpToDate */ ,
    (void *) (INT_PTR) -1 /* ILauncher::PreStartGame */ ,
    (void *) (INT_PTR) -1 /* ILauncher::get_IsGameStarted */ ,
    (void *) (INT_PTR) -1 /* ILauncher::SetSilentModeEnabled */ ,
    (void *) (INT_PTR) -1 /* ILauncher::GetKeyValue */ ,
    (void *) (INT_PTR) -1 /* ILauncher::SetKeyValue */ ,
    (void *) (INT_PTR) -1 /* ILauncher::DeleteKeyValue */ ,
    (void *) (INT_PTR) -1 /* ILauncher::SetStartInHiddenMode */ ,
    (void *) (INT_PTR) -1 /* ILauncher::UnhideApp */ ,
    (void *) (INT_PTR) -1 /* ILauncher::BringAppToFront */ ,
    (void *) (INT_PTR) -1 /* ILauncher::ResetLaunchState */ ,
    (void *) (INT_PTR) -1 /* ILauncher::SetEditMode */ ,
    (void *) (INT_PTR) -1 /* ILauncher::Get_Version */
};


static const PRPC_STUB_FUNCTION ILauncher_table[] =
{
...
CInterfaceStubVtbl _ILauncherStubVtbl =
{
    &IID_ILauncher,
    &ILauncher_ServerInfo,
    26,
    &ILauncher_table[-3],
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    RobloxProxy__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _RobloxProxy_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ILauncherProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _RobloxProxy_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ILauncherStubVtbl,
    0
};

PCInterfaceName const _RobloxProxy_InterfaceNamesList[] = 
{
    "ILauncher",
    0
};

const IID *  const _RobloxProxy_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _RobloxProxy_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _RobloxProxy, pIID, n)

int __stdcall _RobloxProxy_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_RobloxProxy_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo RobloxProxy_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _RobloxProxy_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _RobloxProxy_StubVtblList,
    (const PCInterfaceName * ) & _RobloxProxy_InterfaceNamesList,
    (const IID ** ) & _RobloxProxy_BaseIIDList,
    & _RobloxProxy_IID_Lookup, 
    1,
    2,
